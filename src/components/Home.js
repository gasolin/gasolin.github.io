...
const Home = () => (<div><Slogan />
  <p>I'm an open source supporter, currently work on Mozilla as a <a href="https://wiki.mozilla.org/index.php?title=Modules%2FFirefox&diff=1177818&oldid=1163663"> Firefox module peer</a> and
was involved in the Firefox OS development as a Settings App peer with the faith of pure web operating system.
Before join Mozilla, I published a best selling Android development book (in Taiwan) and I'm also the organizer of <a href="https://www.facebook.com/groups/1614248835348810/?fref=ts">GDG Taipei</a> with the motivation to share emerging web and mobile technologies with communities.
<br/>
