...
const Home = () => (<div><Slogan />
  <div id="summary">
    ...
    <p>The multi-position experience helps me put myself in other's shoes and make cross-functional cooperation (with UI designer, backend engineer) smoothly.</p>
  </div>
